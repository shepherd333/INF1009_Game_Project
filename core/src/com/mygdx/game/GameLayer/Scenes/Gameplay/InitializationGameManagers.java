...
public class InitializationGameManagers {
    private TimerManager timerManager;
    private PlayerController playerController;
    private BucketItemHandler bucketItemHandler;
    private SceneManager sceneManager;

    public InitializationGameManagers(SceneManager sceneManager, AudioManager audioManager, BitmapFont font, SpriteBatch batch, BucketActor bucket) {
