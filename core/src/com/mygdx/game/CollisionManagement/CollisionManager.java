...
public class CollisionManager {
    ...
    public CollisionManager(List<CollidableActor> actors, Array<RaindropActor> raindrops, Array<TrashActor> trash, Array<MetalObjectActor> metalobjects, Stage stage) {
        this.actors = actors;
